...
testIceCreamOrder1: testIceCreamOrder1.o IceCreamOrder.o IceCreamItem.o CustomItem.o tddFuncs.o PreMadeItem.o
	${CXX} $^ -o $@

testIceCreamOrder2: testIceCreamOrder2.o IceCreamOrder.o IceCreamItem.o CustomItem.o tddFuncs.o PreMadeItem.o
	${CXX} $^ -o $@
